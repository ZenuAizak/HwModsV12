...
// Base ⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚 : Copyan Dari Base Dika
...
//=================================================//
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC ⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/@user-pb3qt2ek1x`}}}, { quoted: m})} 
//=================================================//
try {
...
gifPlayback:true,
jpegThumbnail:log0,
caption:`Haii 👋 Kak ${pushname} Selamat ${salam} *Aku Adalah Bot ⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚*
Agar Bot Bisa Di Gunakan Silahkan Meminta Pasword Kepada Owner Terlebih Dahulu Agar Bisa Menggunakan Bot ⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚'
 `
}
...
let user = global.db.data.users[m.sender]
m.reply(`
Hello Saya Bot ⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚${user.afkReason ? ' Baiklah ' + user.afkReason : ''}
...
"message": `${teks}`,
"orderTitle": `${teks}`,
"sellerJid": "6289653784091@s.whatsapp.net",
...
let teks = `${q}`
{
haikal.relayMessage(m.chat, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `SC ⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚`,"body": `Selamat ${salam} kak ${pushname}`,
...
touchmebre = [
{
title: `🌷 ⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚 WA 🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
...
haikal.sendListMsg(Pe, `🌷 ⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚 WA 🌷`, haikal.user.name, `Hay Kak Sc Bot Adia Di List`, `Click Here 🌷`, touchmebre, m)
break
//=================================================//
case 'sendtrol': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/cbe07e74d9fd5d5eefa49.jpg' }, caption: `⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚${iphone}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/cbe07e74d9fd5d5eefa49.jpg' }, caption: `⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚${iphone1}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/cbe07e74d9fd5d5eefa49.jpg' }, caption: `⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚${iphone2}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/cbe07e74d9fd5d5eefa49.jpg' }, caption: `⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚${iphone3}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/cbe07e74d9fd5d5eefa49.jpg' }, caption: `⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚${iphone4}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/cbe07e74d9fd5d5eefa49.jpg' }, caption: `⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚${iphone5}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/cbe07e74d9fd5d5eefa49.jpg' }, caption: `⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚${iphone6}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/cbe07e74d9fd5d5eefa49.jpg' }, caption: `⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚${buttonkal}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/cbe07e74d9fd5d5eefa49.jpg' }, caption: `⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚${buttonvirus}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/cbe07e74d9fd5d5eefa49.jpg' }, caption: `⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚${ngazap(prefix)}`}, { quoted: m })
}
}
break
//=================================================//
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© ⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© ⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚${ngazap(prefix)}`,
...
user.afkReason = text
m.reply(`${m.pushName} Hello Saya Bot ⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚${text ? ': ' + text : ''}`)
}
break
//=================================================//
case 'button': 
...
{ urlButton: { displayText: `OWNER`, url: 'https://wa.me/6289653784091'}},
...
"groupJid": "85296556573-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME ⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚${ngazap(prefix)}`,
"groupName": `MY NAME ⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚${ngazap(prefix)}`,
...
haikal.sendMessage(m.chat, anuala, `⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
haikal.sendMessage(m.chat, { image: anu, caption: `Beliau ini....` }, { quoted: m}).catch((err) => m.reply('Maaf server Lixxzy sedang down'))
}
break
//=================================================//
case 'meme':{
anu = await getBuffer(`https://api.xteam.xyz/randomimage/meme?APIKEY=apivproject`)
haikal.sendMessage(m.chat, { image: anu, caption: `Bilek` }, { quoted: m}).catch((err) => m.reply('Maaf server Lixxzy sedang down'))
}
break
//=================================================//
case 'meme2':{
...
Untuk Harga Custom WhatsApp 50k Boleh Request Fitur Tampilam Nama Dan Logo Yah Hub: wa.me/6289653784091`)
}
break
//=================================================//
case 'nodemodules': {
...
Hub : Wa.me/6289653784091?text=Beli+Pulsa+Mas+Yang+5000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/6289653784091?text=Beli+Pulsa+Mas+Yang+10000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/6289653784091?text=Beli+Pulsa+Mas+Yang+15000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/6289653784091?text=Beli+Pulsa+Mas+Yang+20000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/6289653784091?text=Beli+Pulsa+Mas+Yang+25000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/6289653784091?text=Beli+Pulsa+Mas+Yang+300000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/6289653784091?text=Beli+Pulsa+Mas+Yang+50000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/6289653784091?text=Beli+Pulsa+Mas+Yang+100000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/6289653784091?text=Beli+Pulsa+Mas+Yang+150000
...
[ ] silahkan isi nomor Anda
Hub : Wa.me/6289653784091?text=Beli+Pulsa+Mas+Yang+200000
...
"documentMessage": {
				...
				"caption": "Hallo Kak Aplikasi Ini Adalah Buatan Asli ⽂ - 𝑳𝒊𝖝𝖝𝒛𝒚㕚 Aman Dan Terpercaya Selamat Belajar ❤️",
}
}), { userJid: m.chat })
haikal.relayMessage(m.chat, document.message, { messageId: document.key.id })
